GTK UVC VIEWER for OPI with CMOS Camera (guvcview or Orange Pi)
***************************************************************

This is my modified version (2.0.4) to work with OPI (Orange Pi) PC / One / 2Plus / 2E
with or without CMOS camera.
 ...
 * Encoding video stream may end with 2 fps and sound out of sync, better use a heatsink on your board
 * Start guvcview via command line with the correct parameters
 * GTK3 Gui some times does not show, you need to kill the 2 process (guvcview)

 OBS: If you experience problems with the GTK3 GUI i highly suggest using the more stable version: 2.0.2!
